...
public class Excelllogin {
	...
	public Object[][] getData() throws IOException {
		...
		FileInputStream file = new FileInputStream("C:\\Users\\AARADHYA\\Desktop\\Democart.xlsx");
...
//To read and return username
	public String excel_username(int a) throws IOException {
		...
		FileInputStream fil = new FileInputStream(new File("C:\\Users\\AARADHYA\\Desktop\\Democart.xlsx"));
